...
const connect = function connect() {
  ...
  rdb.connect({
    ...
    password: process.env.RETHINKDB_PASSWORD || '5Kx3ONjWzKeA9oK',
    db: process.env.RETHINKDB_NAME || "casacuentosdb",
    })
    .then(function (conn) {
      connection = conn;
      console.log("Conexion con base de datos realizada con éxito");
